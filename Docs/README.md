...
Please see file [Developer_documentation.pdf](https://github.com/Dmitry-Skachkov/SB/blob/main/Docs/Devepoler_documentation.pdf) for the detailed scheme of the SB program. For any questions related to the code please contact [Dr. Dmitry Skachkov]("Dmitry Skachkov"<dmitry.skachkov@DSedu.org?subject=SB code on GitHub>). 
