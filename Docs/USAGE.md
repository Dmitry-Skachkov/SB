...
* input file *polarization.dat* containing the polarization of the bulk semiconductor with respect to electric field. It may contain only one number for static dielectric constant (see [Example2](https://github.com/Dmitry-Skachkov/SB/tree/main/Examples/Example_1))
